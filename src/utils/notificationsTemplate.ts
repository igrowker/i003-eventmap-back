               ...
               <table cellpadding="0" cellspacing="0" width="100%" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                 <tr>
                  <td align="center" valign="top" style="padding:0;Margin:0;width:560px">
                   <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                     <tr>
                      <td align="center" style="padding:0;Margin:0;padding-bottom:10px;padding-top:20px"><h2 class="es-m-txt-c" style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:26px;font-style:normal;font-weight:bold;line-height:31.2px;color:#333333">Gracias por suscribirte a EventMap 🌎</h2></td>
                     </tr>
                     <tr>
                      <td align="left" class="es-text-4240" style="padding:0;Margin:0;padding-right:40px;padding-left:40px"><h3 style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:20px;font-style:normal;font-weight:bold;line-height:24px;color:#333333"><strong class="es-text-mobile-size-18" style="font-size:18px;line-height:27px !important">Mantente actualizado</strong> <strong class="es-text-mobile-size-18" style="font-size:18px;line-height:27px !important">con información semanal sobre los próximos eventos en toda tu ciudad!</strong><span class="es-text-mobile-size-18" style="font-size:18px;line-height:27px !important"> 😀</span></h3></td>
                     </tr>
                   </table></td>
                 </tr>
               </table></td>
...
<table bgcolor="#ffffff" align="center" cellpadding="0" cellspacing="0" class="es-content-body" role="none" style="background-color:#ffffff;width:600px;border-radius:8px;box-shadow:0 4px 8px rgba(0, 0, 0, 0.1);overflow:hidden;">
  <!-- Lista de Eventos -->
  <tbody id="eventList">
  </tbody>
</table>
          ...
          <td align="center" style="padding:0;Margin:0">
           <table bgcolor="#ffffff" align="center" cellpadding="0" cellspacing="0" class="es-content-body" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#FFFFFF;width:600px">
             <tr class="es-visible-simple-html-only">
              <td align="left" class="es-struct-html" style="Margin:0;padding-top:10px;padding-right:20px;padding-left:20px;padding-bottom:30px">
               <table cellpadding="0" cellspacing="0" width="100%" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                 <tr>
                  <td align="center" valign="top" style="padding:0;Margin:0;width:560px">
                   <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
